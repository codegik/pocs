...
public interface CohesionConnectSoap {
    ...
    @RequestWrapper(localName = "Logon", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.Logon")
    @ResponseWrapper(localName = "LogonResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.LogonResponse")
    public String logon(
    ...
    @RequestWrapper(localName = "Logoff", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.Logoff")
    @ResponseWrapper(localName = "LogoffResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.LogoffResponse")
    ...
    @RequestWrapper(localName = "IsSessionPresent", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.IsSessionPresent")
    @ResponseWrapper(localName = "IsSessionPresentResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.IsSessionPresentResponse")
     ...
     * @param sTran
     * @return
     *     returns com.lendingclub.bankgateway.cohesion.soap.GetHostReplyResult
     */
    ...
    @RequestWrapper(localName = "GetHostReply", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.GetHostReply")
    @ResponseWrapper(localName = "GetHostReplyResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.GetHostReplyResponse")
     ...
     * @param station
     * @return
     *     returns com.lendingclub.bankgateway.cohesion.soap.LogonResult
     */
    ...
    @RequestWrapper(localName = "SessionCreate", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionCreate")
    @ResponseWrapper(localName = "SessionCreateResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionCreateResponse")
    ...
    @RequestWrapper(localName = "SessionEnd", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionEnd")
    @ResponseWrapper(localName = "SessionEndResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionEndResponse")
    ...
    @RequestWrapper(localName = "SessionDisconnect", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionDisconnect")
    @ResponseWrapper(localName = "SessionDisconnectResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionDisconnectResponse")
    ...
    @RequestWrapper(localName = "SessionGetHostReply", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionGetHostReply")
    @ResponseWrapper(localName = "SessionGetHostReplyResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.bankgateway.cohesion.soap.SessionGetHostReplyResponse")
