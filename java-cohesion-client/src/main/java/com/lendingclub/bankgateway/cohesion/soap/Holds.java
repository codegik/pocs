...
@XmlRootElement(name = "Holds", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp")
public class Holds {

    @XmlElement(name = "Hold", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp")
