...
@XmlRootElement(name = "Order", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp")
public class Order {

    @XmlElement(name = "OrderNbr", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp")
    protected int orderNbr;
    @XmlElement(name = "OrderAmt1", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp", required = true)
    protected BigDecimal orderAmt1;
    @XmlElement(name = "OrderAmt2", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp", required = true)
    protected BigDecimal orderAmt2;
    @XmlElement(name = "PlacedDt", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp", required = true)
    protected String placedDt;
    @XmlElement(name = "ReleaseDt", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp", required = true)
    protected String releaseDt;
    @XmlElement(name = "CheckNbr1", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp")
    protected int checkNbr1;
    @XmlElement(name = "CheckNbr2", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp")
    protected int checkNbr2;
    @XmlElement(name = "Payee", namespace = "http://schemas.fidelityinfoservices.com/webservices/miser/vbtp", required = true)
