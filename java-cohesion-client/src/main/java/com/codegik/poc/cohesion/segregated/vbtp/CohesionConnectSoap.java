...
public interface CohesionConnectSoap {
    ...
    @RequestWrapper(localName = "Logon", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.Logon")
    @ResponseWrapper(localName = "LogonResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.LogonResponse")
    public String logon(
    ...
    @RequestWrapper(localName = "Logoff", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.Logoff")
    @ResponseWrapper(localName = "LogoffResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.LogoffResponse")
    ...
    @RequestWrapper(localName = "IsSessionPresent", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.IsSessionPresent")
    @ResponseWrapper(localName = "IsSessionPresentResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.IsSessionPresentResponse")
     ...
     * @param sTran
     * @return
     *     returns com.lendingclub.cohesion.vbtp.GetHostReplyResult
     */
    ...
    @RequestWrapper(localName = "GetHostReply", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.GetHostReply")
    @ResponseWrapper(localName = "GetHostReplyResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.GetHostReplyResponse")
     ...
     * @param station
     * @return
     *     returns com.lendingclub.cohesion.vbtp.LogonResult
     */
    ...
    @RequestWrapper(localName = "SessionCreate", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionCreate")
    @ResponseWrapper(localName = "SessionCreateResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionCreateResponse")
    ...
    @RequestWrapper(localName = "SessionEnd", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionEnd")
    @ResponseWrapper(localName = "SessionEndResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionEndResponse")
    ...
    @RequestWrapper(localName = "SessionDisconnect", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionDisconnect")
    @ResponseWrapper(localName = "SessionDisconnectResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionDisconnectResponse")
    ...
    @RequestWrapper(localName = "SessionGetHostReply", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionGetHostReply")
    @ResponseWrapper(localName = "SessionGetHostReplyResponse", targetNamespace = "http://fidelityifs.com/webservices", className = "com.lendingclub.cohesion.vbtp.SessionGetHostReplyResponse")
