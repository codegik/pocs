...
grpcurl -plaintext -d '{"name": "John Doe", "email": "john@example.com"}' localhost:9090 user.UserService/CreateUser
echo ""

# Create another user
echo "4. Creating another user (Jane Smith):"
grpcurl -plaintext -d '{"name": "Jane Smith", "email": "jane@example.com"}' localhost:9090 user.UserService/CreateUser
echo ""
...
grpcurl -plaintext -d '{}' localhost:9090 user.UserService/ListUsers
echo ""

# Update user
echo "7. Updating user with ID 1:"
grpcurl -plaintext -d '{"id": 1, "name": "John Updated", "email": "john.updated@example.com"}' localhost:9090 user.UserService/UpdateUser
echo ""
